...
struct matrix * make_rotX(double theta) {
  ...
  mtrx->m[1][1] = cos(theta);
  mtrx->m[1][2] = -sin(theta);
  mtrx->m[2][1] = sin(theta);
  mtrx->m[2][2] = cos(theta);
...
struct matrix * make_rotY(double theta) {
  ...
  mtrx->m[2][2] = cos(theta);
  mtrx->m[2][0] = -sin(theta);
  mtrx->m[0][2] = sin(theta);
  mtrx->m[0][0] = cos(theta);
...
struct matrix * make_rotZ(double theta) {
  ...
  mtrx->m[0][0] = cos(theta);
  mtrx->m[0][1] = -sin(theta);
  mtrx->m[1][0] = sin(theta);
  mtrx->m[1][1] = cos(theta);
